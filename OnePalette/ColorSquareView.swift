...
class ColorSquareView: NSView {
    ...
    private var opcolor:OPColor//probaray can change this to just an NSColor
    private var id:Int
    ...
    func config()  {
        ...
        /*calcs the lum of the background do change the color of the text so its visiable*/
